...
class StudentTestCase {
	...
	/*test fixtures*/
	Student student;
	static String DEFAULT_NUME="Anonim";
	...
	void setUp() throws Exception {
		student=new Student(DEFAULT_NUME,DEFAULT_VARSTA,DEFAULT_NOTE);
	}
	...
	void testSetNoteBoundaryCondition() {
		int invalidDataseNote[]=new int[3];
		for(int i=0;i<2;i++) {
			invalidDataseNote[i]=8;
		}
		invalidDataseNote[2]=20;
		assertThrows(StudentExceptionWrongValue.class, () ->{
			student.setNote(invalidDataseNote);
		});
	}
}
